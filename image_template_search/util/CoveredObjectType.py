...
from image_template_search.util.HastyAnnotationV2 import Image, ImageLabel
...
class CoveredObject:
    ...
    source_image: Image = field(metadata={"description": "The source image object"})
    other_images: List[Image] = field(metadata={"description": "List of other images"})
