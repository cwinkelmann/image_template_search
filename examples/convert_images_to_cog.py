...
input_files = Path(
    "/Users/christian/data/2TB/ai-core/data/google_drive_mirror/Orthomosaics_for_quality_analysis/Snt_STJB06_12012023/"
).glob("Snt_STJB01to06_2012023_DDeploy.tif")
input_files = list(input_files)

output_dir = Path(
    "/Users/christian/data/2TB/ai-core/data/google_drive_mirror/Orthomosaics_for_quality_analysis/Snt_STJB06_12012023/cog/all"
)
...
input_base_dir = Path(
    "/Users/christian/Library/CloudStorage/GoogleDrive-christian.winkelmann@gmail.com/.shortcut-targets-by-id/1u0tmSqWpyjE3etisjtWQ83r3cS2LEk_i/Manual Counting /Drone Deploy orthomosaics"
)
...
input_files = [
    f for f in input_files if Path(f).stem not in [Path(f).stem for f in output_files]
]
