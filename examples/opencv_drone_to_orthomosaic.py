...
if __name__ == "__main__":
    ...
    drone_image = (
        base_path
        / "San_STJB01_10012023/template_images/San_STJB01_10012023_DJI_0068/San_STJB01_10012023_DJI_0068.JPG"
    )
    ...
    orthomosaic_path = (
        base_path / "San_STJB01_10012023/San_STJB01_10012023_orthomosaic_Agisoft.tif"
    )  # metashape
    interm_path = Path(
    ...
    drone_image = (
        base_path
        / "FCD01-02-03/template_images/Fer_FCD01-02-03_20122021_single_images/DJI_0366.JPG"
    )
    orthomosaic_path = (
        base_path / "FCD01-02-03/Metashape_FCD01-02-03-orthomosaic.tif"
    )  # metashape
    ...
    ipf = ImagePatchFinderCV(
        template_path=drone_image, large_image_path=orthomosaic_path
    )
