...
if __name__ == "__main__":
    ...
    drone_image_path = (
        base_path
        / "template_images/San_STJB01_10012023_DJI_0068/San_STJB01_10012023_DJI_0068.JPG"
    )
    orthomosaic_path = (
        base_path / "San_STJB01_10012023_orthomosaic_Agisoft.tif"
    )  # Metashape
    ...
    save_polygon_as_geojson(
        buffer,
        local_base_path / f"{drone_image_path.stem}_{buffer_distance}_buffer.geojson",
        EPSG_code=epsg,
    )
